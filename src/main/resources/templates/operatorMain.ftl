                        ...
                        <form method="post">
                            <#list priceList as price>
                                <div class="text-center mt-1">
                                    ...
                                    <input class="form-control text-center" maxlength="5" name="price" aria-label="price"
                                            <#if price.price??> value="${price.price?string["00.00"]}"</#if>oninput="changeHandler(this)"
